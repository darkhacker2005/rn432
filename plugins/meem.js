...
if (Config.WORKTYPE == 'private') {
      ...
      RAVANA.addCommand({pattern: 'mpack', fromMe: true, desc: MEM,}, (async (message, match) => {
    ...
    RAVANA.addCommand({ pattern: 'what ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'Made by DARK KNIGHT BOT' })
