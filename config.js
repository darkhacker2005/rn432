...
module.exports = {
    ...
    MENUTEXT: process.env.MENU_TEXT === undefined ?'*DARK KNIGHT ➠ 🇱🇰*' : process.env.MENU_TEXT,
    MENU_LOGO: process.env.MENU_LOGO === undefined ?  'https://telegra.ph/file/b0f60558bf2d8d354455f.jpg' : process.env.MENU_LOGO,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    OWNER : process.env.OWNER === undefined ? '*🇱🇰 NEXT GEN ™*\n\n```Follow on GutHub```\n🚀 \n\n```Subscrib Youtube Channel```\n🚀 \n\n```Support Group```\n🚀 https://chat.whatsapp.com/KUSz1mWuSla2Li43UXbYiL\n\n*Thank you. ✉*' : process.env.OWNER,
    BRANCH: 'master',
    HEROKU: {
